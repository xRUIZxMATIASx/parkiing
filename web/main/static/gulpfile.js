...
gulp.task('replacePath', function(){
    var replacePath1 = gulp.src(['./pages/*/*.html'], { base: "./" })
        .pipe(replace('="images/', '="../template/images/'))
        .pipe(replace('href="pages/', 'href="../template/pages/'))
        .pipe(replace('href="documentation/', 'href="../template/documentation/'))
        .pipe(replace('href="index.html"', 'href="../template/index.html"'))
        .pipe(gulp.dest('.'));
